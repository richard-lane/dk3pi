#ifndef CHARM_THRESHHOLD_FITTER_H
#define CHARM_THRESHHOLD_FITTER_H
 ...
 */
class CharmThreshholdFcn : public ConstrainXYFcn
{
  public:
    /*
     ...
     */
    CharmThreshholdFcn(const std::vector<double>& data,
     ...
     * world values
     *
     * The chi squared is also constrained based on the BES and CLEO likelihoods
     */
 ...
 * average values
 */
class CharmThreshholdFitter : public ConstrainedFitter
{
  public:
    /*
     ...
     *
     * Must provide the BES phsp bin being considered (this is the same as the CLEO bin but I didn't want to make a new
     * enum)
     */
    CharmThreshholdFitter(const std::vector<double>&   binLimits,
...
#endif // CHARM_THRESHHOLD_FITTER_H
