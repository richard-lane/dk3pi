...
def test_veto():
    ...
    """
    # Ks mass
    pi1 = [0.01073263231, 0.20318581596, 0.03202300965, 0.248807]
    pi2 = [-0.01073263231, -0.20318581596, -0.03202300965, 0.248807]
    assert phsp_parameterisation.vetoed(pi1, pi2)

    # Not Ks mass
    pi1 = [0.13426039316, -0.03393146458, -0.14194811602, 0.2425]
    pi2 = [-0.13426039316, 0.03393146458, 0.14194811602, 0.2425]
